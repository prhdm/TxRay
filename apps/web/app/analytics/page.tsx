...
import { Card, CardContent } from '@txray/ui'

// Dynamically import components to avoid SSR issues
const AnalyticsProvider = dynamic(() => import('../contexts/AnalyticsContext').then(mod => ({ default: mod.AnalyticsProvider })), { ssr: false })
