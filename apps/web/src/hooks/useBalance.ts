...
export const useBalance = (address?: `0x${string}`, tokenId: bigint = 0n): BalanceResult => {
...
export const useUserBalance = (tokenId: bigint = 0n): BalanceResult => {
