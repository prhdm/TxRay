-- Wallet Authentication System Tables
-- SIWE nonces, user profiles, and session management
...
CREATE TABLE IF NOT EXISTS auth_sessions (
  ...
  expires_at timestamptz NOT NULL,
  hard_expires_at timestamptz NOT NULL, -- absolute maximum expiration
...
-- RLS Policies for auth_sessions (service role only)
...
-- Function to clean up expired nonces (optional, can be called by cron)
