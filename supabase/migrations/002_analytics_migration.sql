...
SELECT 
  ...
  coalesce(a.gas_used_sum,0)::text AS gas_used,
  coalesce(a.gas_cost_sum,0)::text AS gas_cost
FROM (
  SELECT 
    CASE granularity
...
GRANT EXECUTE ON FUNCTION kpi_timeseries TO authenticated;
GRANT EXECUTE ON FUNCTION kpi_summary_wallet TO authenticated;
GRANT EXECUTE ON FUNCTION kpi_timeseries_wallet TO authenticated;
GRANT EXECUTE ON FUNCTION get_unique_wallets TO authenticated;
GRANT EXECUTE ON FUNCTION get_method_stats TO authenticated;
GRANT EXECUTE ON FUNCTION get_top_wallets TO authenticated;


-- SELECT 'Testing global KPI summary:' as test;
-- SELECT * FROM kpi_summary;

-- -- Test the global timeseries
-- SELECT 'Testing global timeseries:' as test;
-- SELECT * FROM kpi_timeseries('day', NOW() - INTERVAL '7 days', NOW()) LIMIT 5;

-- -- Test method distribution
-- SELECT 'Testing method distribution:' as test;
-- SELECT * FROM method_distribution;

-- -- Test daily activity
-- SELECT 'Testing daily activity:' as test;
-- SELECT * FROM daily_activity LIMIT 5;

-- -- Test wallet ranking
-- SELECT 'Testing wallet activity ranking:' as test;
-- SELECT * FROM wallet_activity_ranking LIMIT 5;

-- -- Test helper functions
-- SELECT 'Testing helper functions:' as test;
-- SELECT get_unique_wallets() as unique_wallets;
-- SELECT * FROM get_method_stats();
-- SELECT * FROM get_top_wallets(5);
